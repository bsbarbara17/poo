...
public class Game extends JFrame implements KeyListener {
	...
	private Booster booster = new Booster(400, 400, false, 0);
	...
	private void init() {
		setLayout(null);
		player.setTamanho(SCREENSIZE);
		player.setVidas(15);

		ghost1.setTamanho(SCREENSIZE);
		ghost2.setTamanho(SCREENSIZE);
		ghost3.setTamanho(SCREENSIZE);
		ghost4.setTamanho(SCREENSIZE);
